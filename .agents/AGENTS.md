...
## 2. Git & Release Management (Strict Git Branching)
...
## 4. Backend Architecture Standards (FastAPI + Async PostgreSQL)
...
## 5. Strict Mobile-First & Touch-Friendly UX
...
## 6. Known Gotchas & Bug Fixes (Memory Bank)
