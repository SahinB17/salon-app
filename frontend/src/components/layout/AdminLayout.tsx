...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 lg:flex">
      ...
      <aside className="hidden lg:flex lg:w-64 lg:flex-col fixed inset-y-0 left-0 bg-zinc-950 text-white z-50">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-h-screen pb-20 lg:pb-0">
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-zinc-200 px-2 pb-safe pt-1 z-50">
          <div className="flex justify-around items-center h-16 max-w-md mx-auto">
            ...
            <button
              onClick={handleLogout}
              className="flex flex-col items-center justify-center w-full h-full space-y-1 transition-colors min-w-[64px] text-zinc-400 hover:text-red-500"
            >
