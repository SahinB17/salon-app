        ...
        <CardContent>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-zinc-500 hover:text-zinc-950 transition-colors">
                    Şifrəni unutmusunuz?
                  </a>
                </div>
                <Input
            ...
            <p className="text-center text-sm text-zinc-500 mt-6">
              Hesabınız yoxdur?{' '}
              <a href="#" className="font-medium text-zinc-950 hover:underline underline-offset-4">
                Qeydiyyatdan keçin
              </a>
            </p>
          </form>
